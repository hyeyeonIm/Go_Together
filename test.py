...
def STT():
    ...
    # def get_duration(x=3):
    #     seconds = int(x)
    #     nanos = (int (x * 1000) % 1000) * 1000000
    #     return duration_pb2.Duration(seconds = seconds, nanos=nanos)
    
    speech_start_timeout = duration_pb2.Duration(seconds = 0, nanos= 0)
    speech_end_timeout = duration_pb2.Duration(seconds = 5, nanos=2000)
    
    timeout_obj = speech.StreamingRecognitionConfig.VoiceActivityTimeout(
        speech_start_timeout = speech_start_timeout,
        speech_end_timeout	= speech_end_timeout
    )
    # streaming_features = speech_v2.StreamingRecognitionFeatures(
    #     enable_voice_activity_events = True,
    #     interim_results = True, # do i need this?
    #     voice_activity_timeout = timeout_obj
    # )
